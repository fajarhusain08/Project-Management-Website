                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control form-control-sm" autocomplete="off" name="start_date" id="start_date" value="<?php echo isset($project['start_date']) ? date("Y-m-d", strtotime($project['start_date'])) : '' ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="" class="control-label">End Date</label>
                                    <input type="date" class="form-control form-control-sm" autocomplete="off" name="end_date" id="end_date" value="<?php echo isset($project['end_date']) ? date("Y-m-d", strtotime($project['end_date'])) : '' ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm select2" name="manager_id" id="manager_id">
                                        ...
                                        <?php foreach ($manager as $ma) : ?>
                                            ...
                                            <option value="<?php echo $ma['id'] ?>" <?php echo isset($project['manager_id']) && $project['manager_id'] == $ma['id'] ? "selected" : '' ?>><?php echo ucwords($ma['name']) ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm select2" multiple="multiple" name="user_ids[]" id="user_ids[]">
                                        ...
                                        <?php foreach ($member as $m) : ?>
                                            <option value="<?php echo $m['id'] ?>" <?php echo isset($project['user_ids']) && in_array($m['id'], explode(',', $project['user_ids'])) ? "selected" : '' ?>><?php echo ucwords($m['name']) ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
